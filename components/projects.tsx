...
export const Projects = () => {
  return (
    <section
      ...
      className={
        sora.className +
        " relative w-full h-auto max-w-[1050px] mx-auto text-white text-3xl before:w-full py-20 px-[30px]"
      }
    >
      <div className="">
        ...
        <span className="dt absolute top-0 md:-top-[30px] right-0 opacity-25 pointer-events-none">
          Projects
        </span>
      </div>
    </section>
